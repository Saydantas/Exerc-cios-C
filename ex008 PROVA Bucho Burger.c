/*Uma das franquias fictícias de maior sucesso, especializada em sanduíches regionais, é 
o Bucho Burger. Porém, apesar de ser muito bom em fazer sanduíches, o seu dono não é tão 
apto a fazer contas de matemática, e frequentemente tem problemas para acertar o troco 
ou saber quando está faltando alguma coisa no pagamento.
...
dinheiro pago pelo cliente, e informará se o valor está correto, se precisa de troco 
ou se está faltando dinheiro.
...
4 23	                        Saldo insuficiente! Falta 5 reais
*/
...
int main(){
    ...
    if(p == 1){
        if(d == 12){
            ...
            printf("Saldo insuficiente! Falta %d reais", 12 - d);
        }
        else if(d > 12){
            printf("Troco = %d reais", d - 12);
        }
    }
    else if(p == 2){
        if(d == 23){
            ...
            printf("Saldo insuficiente! Falta %d reais", 23 - d);
        }
        else if(d > 23){
            printf("Troco = %d reais", d - 23);
        }
    }
    else if(p == 3){
        if(d == 31){
            ...
            printf("Saldo insuficiente! Falta %d reais", 31 - d);
        }
        else if(d > 31){
            printf("Troco = %d reais", d - 31);
        }
    }
    else if(p == 4){
        if(d == 28){
            ...
            printf("Saldo insuficiente! Falta %d reais", 28 - d);
        }
        else if (d > 28){
            printf("Troco = %d reais", d - 28);
        }
    }
    else if(p == 5){
        if(d == 15){
            ...
            printf("Saldo insuficiente! Falta %d reais", 15 - d);
        }
        else if(d > 15){
            printf("Troco = %d reais", d - 15);
        }
    }
    return 0;
}
